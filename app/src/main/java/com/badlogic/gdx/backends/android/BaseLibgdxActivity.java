...
public class BaseLibgdxActivity extends AppCompatActivity implements AndroidApplicationBase {
    ...
    private void init(ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
        if (this.getVersion() < 8) {
            ...
            this.addLifecycleListener(new LifecycleListener() {
                ...
                public void pause() {
                    BaseLibgdxActivity.this.audio.pause();
                }

                public void dispose() {
                    BaseLibgdxActivity.this.audio.dispose();
                }
            });
            Gdx.app = this;
...
//        this.graphics.onPauseGLSurfaceView();
    ...
    protected void onResume() {
        Log.d("spine/dragon", "base_resume");
        Gdx.app = this;
        Gdx.input = this.getInput();
        Gdx.audio = this.getAudio();
        Gdx.files = this.getFiles();
    ...
    public void exit() {
        this.handler.post(new Runnable() {
            public void run() {
                BaseLibgdxActivity.this.finish();
            }
        });
    }
