...
public class NewTransformPage implements ViewPager.PageTransformer {
     ...
     */
    public NewTransformPage(int mScaleOffset) {
...
//            page.setRotation((45 * position));
            ...
            page.setTranslationY((mScaleOffset * 1.5f) * position);        }
