...
//        }
//        // 算出需要显示第几帧
//        mCurrentAnimationTime = (int) ((now - mMovieStart) % (dur * 10)) / 10;
//
//        Log.d("msg", "now" + now);
//        Log.d("msg", "动画时长" + mMovie.duration());
//        Log.d("msg", "current" + mCurrentAnimationTime);
//        Log.d("msg", "start" + mMovieStart);
//        Log.d("msg", "差" + (now - mMovieStart));
...
//            mCurrentAnimationTime = 0;
        ...
        mCurrentAnimationTime += 2;
        Log.d("msg", "" + mCurrentAnimationTime);
