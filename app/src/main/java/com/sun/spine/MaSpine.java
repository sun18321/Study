...
public class MaSpine extends ApplicationAdapter {

    private static MaSpine mMaSpine;
    ...
    public static MaSpine getInstance(Context context) {
        if (mMaSpine == null) {
            mContext = context;
            mMaSpine = new MaSpine();
        }
        return mMaSpine;
    }
...
//        stateData.setMix("long-m", "long-m", 0.2f);
        ...
        state.setAnimation(0, "long-m", false);
