...
public class CarUpAnimation {
    ...
    public CarUpAnimation(Activity context, View rootView) {
    ...
    public void startCarOnAnimation() {
        ...
        //动画阶段1
        final Animation carAnimation = AnimationUtils.loadAnimation(context, R.anim.car_up_anim1);
        carAnimation.getFillAfter();
        final Animation carAnimation2 = AnimationUtils.loadAnimation(context, R.anim.car_up_anim2);
        carAnimation2.getFillAfter();
        final Animation carAnimation3 = AnimationUtils.loadAnimation(context, R.anim.car_up_anim3);
...
//                }
//                if (context instanceof OneToOneActivity) {
//                    OneToOneActivity temp_activity = (OneToOneActivity) context;
//                    //显示礼物动画
//                    temp_activity.hasAnyLuxuryGift();
//                }
            }
