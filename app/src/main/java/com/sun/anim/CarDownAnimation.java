...
public class CarDownAnimation {
    ...
    public CarDownAnimation(Activity context, View rootView) {
...
//                        });
    ...
    public void startCarOnAnimation() {
        ...
        //动画阶段1
        final Animation carAnimation = AnimationUtils.loadAnimation(context, R.anim.car_down_anim1);
        carAnimation.getFillAfter();
        final Animation carAnimation2 =
                AnimationUtils.loadAnimation(context, R.anim.car_down_anim2);
        ...
        carAnimation3.setAnimationListener(new Animation.AnimationListener() {
            ...
            @Override public void onAnimationEnd(Animation animation) {
                ...
                car3_down.postDelayed(new Runnable() {
                    @Override public void run() {
                        CarUpAnimation car3upAnimation =
                                new CarUpAnimation(context, context.findViewById(R.id.car_3_up));
